...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="styles/css/tether/tether.min.css">
        <link rel="stylesheet" href="styles/css/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="styles/css/bootstrap/css/bootstrap-grid.min.css">
        <link rel="stylesheet" href="styles/css/bootstrap/css/bootstrap-reboot.min.css">
        <link rel="stylesheet" href="styles/css/dropdown/css/style.css">
        <link rel="stylesheet" href="styles/css/socicon/css/styles.css">
        <link rel="stylesheet" href="styles/css/theme/css/style.css">
        <link rel="preload" as="style" href="styles/css/mobirise/css/mbr-additional.css"><link rel="stylesheet" href="styles/css/mobirise/css/mbr-additional.css" type="text/css">
        <!-- logos -->
